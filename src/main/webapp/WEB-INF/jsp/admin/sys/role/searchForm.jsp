...
<form id="searchForm" method="post" class="form-inline search-form" data-change-search="true">
    ...
    <label >角色名称</label>
    <input name="search_LIKE_roleName" value="${LIKE_roleName}"  class="input-small" placeholder="模糊匹配"/>
    &nbsp;&nbsp;
    <label >角色代码</label>
    <input name="search_LIKE_role.roleCode" value="${LIKE_role_roleCode}"  class="input-small" placeholder="模糊匹配"/>
    &nbsp;&nbsp;
