...
<div class="index-panel">
    ...
    <div class="tabs-bar tabs-fix-top">
        ...
        <div id="tabs-0" data-index="0" data-url="${ctx}/admin/sys/notice/common/welcome"></div>

    </div>

   <iframe id="iframe-tabs-0" tabs="true" class="ui-layout-center" 
            frameborder="0" scrolling="auto" src="${ctx}/admin/sys/notice/common/welcome"></iframe>
